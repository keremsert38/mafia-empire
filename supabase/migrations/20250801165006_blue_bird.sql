/*
  # Kayıt Sistemi Düzeltmeleri - auth.config olmadan
...
-- 1. Mevcut kullanıcıları confirm et (eğer varsa)
UPDATE auth.users 
...
CREATE POLICY "Allow all operations" ON player_stats
  FOR ALL USING (true);
...
-- 7. Test kullanıcıları ekle (sadece yoksa)
...
-- 8. Real-time subscription'ları etkinleştir
